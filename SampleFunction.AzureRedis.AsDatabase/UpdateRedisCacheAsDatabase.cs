...
namespace SampleFunction.AzureRedis.AsDatabase
{
    using Helpers;

    /// <summary>
    /// Sample Azure function to demonstrate use AzureRedisAttribute as Azure Cache Database connection.    
    /// </summary>
    public static class UpdateRedisCacheAsDatabase
    {
        #region Function Code

        /// <summary>
        /// BLOB trigger which updates value of keys in Azure Cache when file is updated
        /// </summary>
        /// <param name="myBlob">BLOB Stream reference</param>
        /// <param name="redisCache">Reference to Azure Redis Cache as a Cache Database</param>
        /// <param name="log">Log Writer</param>
        /// <returns></returns>
        [FunctionName("UpdateRedisCacheAsDatabase")]
                ...
                TraceWriter log)
        {
            ...
            try
            {
                ...
                var redisCacheHelper = new RedisCacheHelper(redisCache);
